...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <a href="{{URL::to('/')}}" class="btn btn-danger">Sign In</a> </span>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<img src="{{URL::to('img/demo/iphoneview.png')}}" alt="" class="pull-right display-image" style="width:210px">
