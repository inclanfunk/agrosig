								...
								<div class="row">
									<section class="col col-6">
										<label class="input"> <i class="icon-append fa fa-briefcase"></i>
											<input type="text" name="code" placeholder="Part Code" required>
										</label>
										@if($errors->first('code'))
											<em class="invalid">{{ $errors->first('code') }}</em>
										@endif
									</section>
									<section class="col col-6">
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" name="description" placeholder="Part Description" required>
										</label>
