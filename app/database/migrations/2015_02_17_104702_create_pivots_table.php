...
class CreatePivotsTable extends Migration {
	...
	public function up()
	{
		Schema::create('pivots', function(Blueprint $table)
		{
			...
			$table->string('qoa_arms_10_quantity');
			$table->string('qoa_arms_10_length');
			$table->double('qoa_arms_10_ndd', 15, 8);
			$table->double('qoa_arms_10_ddd', 15, 8);
			$table->string('qoa_arms_8_5by8_quantity');
			$table->string('qoa_arms_8_5by8_length');
			$table->double('qoa_arms_8_5by8_ndd', 15, 8);
			$table->double('qoa_arms_8_5by8_ddd', 15, 8);
			$table->string('qoa_arms_6_5by8_quantity');
			$table->string('qoa_arms_6_5by8_length');
			$table->double('qoa_arms_6_5by8_ndd', 15, 8);
			$table->double('qoa_arms_6_5by8_ddd', 15, 8);
			...
			$table->enum('main_fuses', array('10 amp', '12 amp', '15 amp', '17 amp', '20 amp', '25 amp'));
			$table->string('main_fuses_comment');
			$table->enum('panel_fuses', array('2 amp', '4 amp', '5 amp'));
